...
const badgeVariants = cva(
	"inline-flex items-center rounded-full border border-zinc-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-950 focus:ring-offset-2 dark:border-zinc-800 dark:focus:ring-zinc-300",
	{
		variants: {
			variant: {
				default:
					"border-transparent bg-primary-foreground text-primary hover:bg-zinc-900/80 dark:hover:bg-zinc-50/80",
				secondary:
					"border-transparent bg-secondary text-secondary-foreground hover:bg-zinc-100/80 dark:hover:bg-zinc-800/80",
				destructive:
